...
**Performance**
- Bulk load optimisation: local `HashMap` currency cache within the ingestion loop to avoid repeated DB round-trips, combined with `saveAll()` and Hibernate batch insert (`batch_size: 500`) - this reduced ~570k DB operations to ~570
